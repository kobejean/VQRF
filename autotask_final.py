...
def run_exp(env,  config, datadir, expname, basedir, rgbnet_depth, rgbnet_width):
    ...
    cfg.coarse_model_and_render.rgbnet_depth = cfg.fine_model_and_render.rgbnet_depth = cfg.vq_model_and_render.rgbnet_depth = rgbnet_depth
    cfg.coarse_model_and_render.rgbnet_width = cfg.fine_model_and_render.rgbnet_width = cfg.vq_model_and_render.rgbnet_width = rgbnet_width
    
    auto_config_path = f'./configs/auto/{expname}_d{rgbnet_depth}_w{rgbnet_width}.py'
...
for depth in range(6,9):
    ...
    for scene in datasetting["scene_list"]:
        ...
        task["basedir"] = datasetting["basedir"] + f'_d{depth}_w{width}'
        task["rgbnet_depth"] = depth
        task["rgbnet_width"] = width
